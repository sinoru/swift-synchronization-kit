...
internal enum _MemoryOrder {
    @usableFromInline static var relaxed: Int32 { 0 }
    @usableFromInline static var acquiring: Int32 { 2 }
    @usableFromInline static var releasing: Int32 { 3 }
    @usableFromInline static var acquiringAndReleasing: Int32 { 4 }
    @usableFromInline static var sequentiallyConsistent: Int32 { 5 }
}
